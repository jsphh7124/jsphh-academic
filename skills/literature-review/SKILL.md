...
5. **Avoid AI writing tropes**: Consult `~/.claude/skills/_references/ai-writing-tropes.md` ([tropes.fyi](https://tropes.fyi)) to avoid patterns that signal AI-generated text — including overused words ("delve", "landscape", "tapestry"), structural tics (negative parallelism, fractal summaries), and tonal issues (false suspense, grandiose stakes inflation)
