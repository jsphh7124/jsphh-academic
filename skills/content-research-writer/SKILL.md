...
When writing or reviewing content, consult the shared reference file for common AI writing patterns that make text sound artificial:

> **`~/.claude/skills/_references/ai-writing-tropes.md`**
> Source: [tropes.fyi](https://tropes.fyi)

Key categories to watch for:
- **Word choice**: Avoid "delve", "tapestry", "landscape", "serves as", and magic adverbs ("quietly", "deeply", "fundamentally")
- **Sentence structure**: Avoid negative parallelism ("It's not X — it's Y"), rhetorical self-questions ("The result? Devastating."), anaphora/tricolon abuse
- **Tone**: Avoid false suspense ("Here's the kicker"), patronizing analogies ("Think of it as..."), grandiose stakes inflation
- **Formatting**: Avoid em-dash overuse, bold-first bullets, unicode decoration
- **Composition**: Avoid fractal summaries, one-point dilution, signposted conclusions ("In conclusion...")

Apply these checks during section feedback (Step 5) and final review (Step 8).
